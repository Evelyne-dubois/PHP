      ...
      <iframe id="create_shop-popup" class="white-popup mfp-hide" src="create-shop.view.php" scrolling="no";></iframe>
        ...
        <div id="banner" class="banner-home">
            <div class="container">
                ...
                <!-- <h1>Bienvenue sur Garden Shop</h1>
                <p>Nous sommes une petite communauté de jardiniers et de consommateurs 
à la recherche d’échange, de conseil et de partage.</p>
                <p>Pour participer à cette expérience en temps que cultivateur, vous devez vous 
                  <a href="
                  <?php 
                    if(!isset($_SESSION["id"])){
                      echo '#connexion-popup" class="open-popup-link';
                  ...
                  <!-- <p>Celui de donner, vendre ou échanger nos surplus de récoltes.</p> -->
                  <!-- <p>Nous expérimentons un nouveau mode de consomation, celui de donner vendre ou echanger nos surplus de récoltes.</p> -->
                  <!-- <p>Donner, vendre ou échanger nos surplus de récoltes.</p> -->
                  <!-- <p>Le but étant de ne plus gaspillez de bons produits frais, et de proposez au consomateur plus de choix</p> -->

                  <p>Pour participer à cette expérience en tant que cultivateur, vous devez vous 
                  <a href="
                  <?php 
                    if(!isset($_SESSION["id"])){
                      echo '#connexion-popup" class="open-popup-link';
