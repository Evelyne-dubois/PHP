            ...
            <div class="container">
                <nav id="main-menu">
                    <ul id="main-menu_links">
                        ...
                        <li><a class="current" href="cueillettes.php">Cueillir<span>chez l'hôte</span></a></li>
                    </ul>
              ...
              <nav id="main-menu-smartphone">
                    ...
                    <ul id="main-menu-links-smartphone">
                        ...
                        <li class="text-center"><a href="
                          ...
                          ?>
                          ">Ajouter</a></li>
                        <li class="text-right"><a class="current" href="cueillettes.php">Cueillir</a></li>
                    </ul>
                        ...
                        <fieldset class="modalite">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <input type="text" name="adresse_numero" class="numero" id="auto_numero" placeholder="n°" value="<?php if( !empty( $_POST['adresse_numero'] ) ) echo $_POST['adresse_numero']; ?>"/>
                                    <input type="text" name="adresse_rue" class="rue" id="auto_rue" placeholder="Rue" value="<?php if( !empty( $_POST['adresse_rue'] ) ) echo $_POST['adresse_rue']; ?>"/>
                                </li>
                                <li>
                                    ...
                                    <input type="text" name="adresse_cp" class="cp" id="auto_cp" placeholder="Localité" value="<?php if( !empty( $_POST['adresse_cp'] ) ) echo $_POST['adresse_cp']; ?>"/>
                                    <input type="text" name="adresse_ville" class="ville" id="auto_ville" placeholder="Ville" value="<?php if( !empty( $_POST['adresse_ville'] ) ) echo $_POST['adresse_ville']; ?>"/>
                                </li>
                            </ul>
